    ...
    <div className="p-6 space-y-6 max-w-2xl">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Connected authentication providers</CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Platform deployment information</CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div>
              ...
              <code className="text-xs font-mono text-muted-foreground break-all">
                {process.env.NEXT_PUBLIC_API_URL || "https://api.etalbaas.io"}
              </code>
            </div>
            <div>
              <p className="text-xs text-muted-foreground">Auth Provider</p>
              <p className="text-sm">GoTrue (Self-hosted)</p>
            </div>
          </div>
        </CardContent>
      </Card>
